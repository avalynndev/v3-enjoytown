...
import type { Language, Season } from "@/tmdb";
...
export function TvSerieSeasonsOverview({
  ...
  return (
    <ScrollArea className="overflow-auto! relative h-[80vh] max-w-4xl">
      <Table>
        <TableHeader className="sticky top-0 bg-background z-10 after:absolute after:bottom-0 after:left-0 after:w-full after:h-px after:bg-border">
